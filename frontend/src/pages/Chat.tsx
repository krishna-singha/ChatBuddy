      ...
      {selectedConversation ? (
        <>
          <div className="flex-1 flex flex-col bg-gray-900/80 backdrop-blur-xl border-l border-cyan-500/10">
            ...
            <div className="flex-1 flex flex-col overflow-y-auto p-6 space-y-5 scrollbar-thin scrollbar-thumb-cyan-500/30 scrollbar-track-transparent">
              {Object.entries(messageGroups).length > 0 ? (
                ...
                <div className="flex flex-1 items-center justify-center text-center text-gray-500 px-4">
                  <div className="max-w-sm space-y-4">
                    <div className="text-6xl">💬</div>
                    <div className="text-xl font-semibold">No messages yet</div>
                    <p className="text-sm text-gray-400">Start the conversation and say hello!</p>
                  </div>
                </div>
